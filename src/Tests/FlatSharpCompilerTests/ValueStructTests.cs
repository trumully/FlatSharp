...
public class ValueStructTests
{
    ...
    public void ValueStruct_ToString()
    {
        ...
        Assert.Contains("public override string ToString() => $\"Struct A {{ __flatsharp__Test_0 = {this.__flatsharp__Test_0}, __flatsharp__Test_1 = {this.__flatsharp__Test_1}, __flatsharp__Test_2 = {this.__flatsharp__Test_2}, __flatsharp__Test_3 = {this.__flatsharp__Test_3}, __flatsharp__Test_4 = {this.__flatsharp__Test_4} }}\";", csharp);
    }
